...
export const START_SEARCH_POSTS_REFRESHING = 'start_search_posts_refreshing';
export const STOP_SEARCH_POSTS_REFRESHING = 'stop_search_posts_refreshing';
export const START_SEARCH_USERS_REFRESHING = 'start_search_users_refreshing';
export const STOP_SEARCH_USERS_REFRESHING = 'stop_search_users_refreshing';
export const START_SEARCH_TOPICS_REFRESHING = 'start_search_topics_refreshing';
export const STOP_SEARCH_TOPICS_REFRESHING = 'stop_search_topics_refreshing';
...
export const SHOW_RESULT_TABS = 'show_result_tabs';
