...
class ChooseTopicScreen extends Component {
  componentDidMount() {
    this.props.getSubscribedTopics(this.props.id, false, 'lowercase_name', 'ASC', this.props.navigation);
  }
  ...
  handleRefresh = () => this.props.getSubscribedTopics(this.props.id, true, 'lowercase_name', 'ASC', this.props.navigation)
